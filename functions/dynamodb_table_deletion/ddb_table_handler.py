...
def lambda_handler(event, context):
    ...
    recreateTable(SHIPMENT_RECORD_TABLE, 'addrHashCode', 'recordId')
    #deleteTableContentWithSortKey(SHIPMENT_RECORD_TABLE, 'addrHashCode', 'recordId')
    ...
    deleteTableContent(SHIPMENT_HASH_TABLE, 'addrHashCode')
