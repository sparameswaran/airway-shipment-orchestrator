...
def lambda_handler(event, context):
    ...
    for record in event['Records']:
        ...
        """
        # Data from SNS - actaul message payload is inside body -> message
        ...
        # Message has json quotes while the message attributes uses dict style
        # convert individual messages into dict before dumping into json when we pass the entire array
